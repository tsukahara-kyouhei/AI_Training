...
CREATE TABLE IF NOT EXISTS customer_coupon_usages (
    ...
    CONSTRAINT fk_customer_coupon_usages_member FOREIGN KEY (customer_id)
        REFERENCES members (member_id) ON DELETE CASCADE,
    CONSTRAINT fk_customer_coupon_usages_coupon FOREIGN KEY (coupon_id)
...
-- =====================================================================
ALTER TABLE orders ADD COLUMN IF NOT EXISTS applied_coupon_code VARCHAR(50);
ALTER TABLE orders ADD COLUMN IF NOT EXISTS discount_amount NUMERIC(12,0) NOT NULL DEFAULT 0 CHECK (discount_amount >= 0);
