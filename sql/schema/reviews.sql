CREATE TABLE IF NOT EXISTS product_reviews (
    ...
    CONSTRAINT fk_product_reviews_member FOREIGN KEY (member_id) REFERENCES members (member_id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_product_reviews_product_published_created ON product_reviews (product_id, is_published, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_product_reviews_member_product ON product_reviews (member_id, product_id);
