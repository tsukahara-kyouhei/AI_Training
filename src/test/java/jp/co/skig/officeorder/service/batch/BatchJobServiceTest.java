...
class BatchJobServiceTest {
        ...
        void executePopularRanking_正常系_販売数量降順で上位10件を保存する() {
                ...
                ArgumentCaptor<List<BatchRepository.PopularRankingCandidate>> captor = ArgumentCaptor
                                .forClass(List.class);
        ...
        void executeRecommendedRelated_正常系_共起商品をスコア順で保存する() {
                ...
                ArgumentCaptor<List<BatchRepository.RecommendedRelatedRow>> captor = ArgumentCaptor
                                .forClass(List.class);
