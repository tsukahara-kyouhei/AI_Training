...
class ProductListSearchServiceTest {
    ...
    void buildNewArrivalCondition_正常系_生入力を正規化してproductServiceへ委譲する() {
        ...
        ProductListSearchService service = new ProductListSearchService(productService, productFilterOptionService);
        ...
        ProductSearchCondition result = service.buildNewArrivalCondition(true, List.of(1, 2), List.of("red"), "newest", 2, 30, bundle);
