 ...
 * 会員情報変更画面のフォームモデル。
 */
public class MemberProfileEditForm implements Serializable {
    ...
    /**
     * 更新前に入力文字列を trim し、未入力を null に寄せた複製を返す。
     */
    public MemberProfileEditForm normalize() {
        MemberProfileEditForm normalized = new MemberProfileEditForm();
