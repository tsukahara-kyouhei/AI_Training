...
public final class ValidationPatterns {
        ...
        /** 未入力または決済方法コードを許容する。 */
        public static final String BLANK_OR_PAYMENT_METHOD = "^$|^(bank_transfer|cash_on_delivery|convenience_store)$";
        /** 未入力またはお問い合わせ種別コードを許容する。 */
        public static final String BLANK_OR_INQUIRY_TYPE = "^$|^(product|delivery_date|order|shipping|return_cancel|other)$";
